...
class KMLRenamerApp(QWidget):
    ...
    def __init__(self):
        ...
        # --- Atributos dos Widgets de Configuração ---
        # Estes widgets são criados UMA VEZ no init_ui e reutilizados
    ...
    def update_rule(self):
        ...
        if selected_fields:
            ...
            # Se nenhum campo for selecionado, remove a regra
    ...
    def process_files(self):
        ...
        for model_signature, rule in self.renaming_rules.items():
            if not rule.get("fields"):  # Pula regras sem campos selecionados
                continue
...
def iniciar_aplicacao_principal():
    """Cria a instância da aplicação PyQt6 e a executa."""
